...
# Calculator
# environment, range, function, variable):
f_ast_calculator = F_AST_Calculator(env, [-10, 10], function, 'x')


GA = ASTGeneticAlgorithm(tree_generator, population_size, f_ast_calculator, env, mutation_rate)
